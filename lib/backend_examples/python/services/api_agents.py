...
class ApiAgentsService:
    ...
    # Alias for compatibility with context_service
    def list_agents_by_user_id(
        self,
        user_id: str,
        status: Optional[str] = None,
    ) -> List[Dict[str, Any]]:
        """Alias for list_agents_for_user for compatibility."""
        return self.list_agents_for_user(user_id, status)
    
    # =====================================================
    # READ (list all agents - admin function)
    # =====================================================
    def list_all_agents(
        self,
        status: Optional[str] = None,
        ...
        """
        List all agents across all users (for admin/UI purposes).
        Useful for GitMem landing page that shows all agent repositories.
        """
        query = (
            self.client
            .table(self.TABLE_NAME)
